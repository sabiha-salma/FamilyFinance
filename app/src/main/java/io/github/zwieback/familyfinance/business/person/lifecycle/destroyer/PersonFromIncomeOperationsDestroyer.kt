...
internal class PersonFromIncomeOperationsDestroyer(
    context: Context,
    ...
    override val alertResourceId: Int
        get() = R.string.income_operations_with_owner_exists

    override fun next(): EntityDestroyer<Person>? {
        return PersonFromTransferOperationsDestroyer(context, data)
    }
