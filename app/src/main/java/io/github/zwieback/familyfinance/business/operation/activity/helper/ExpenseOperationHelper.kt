...
import io.github.zwieback.familyfinance.business.operation.activity.ExpenseOperationEditActivity.Companion.INPUT_EXPENSE_TO_WHOM_ID
...
class ExpenseOperationHelper(context: Context, data: ReactiveEntityStore<Persistable>) :
    ...
    override fun addOperationImmediately(
        ...
        val accountId = intent.getIntExtra(INPUT_EXPENSE_ACCOUNT_ID, EMPTY_ID)
        val articleId = intent.getIntExtra(INPUT_EXPENSE_ARTICLE_ID, EMPTY_ID)
