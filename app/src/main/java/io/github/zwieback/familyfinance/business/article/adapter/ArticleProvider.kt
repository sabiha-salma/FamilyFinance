...
class ArticleProvider(context: Context) : EntityProvider<Article>(context) {

    @Suppress("PARAMETER_NAME_CHANGED_ON_OVERRIDE")
    override fun provideDefaultIcon(article: Article): IIcon {
    ...
    @Suppress("PARAMETER_NAME_CHANGED_ON_OVERRIDE")
    override fun provideDefaultIconColor(article: Article): Int {
        return if (article.isFolder) {
