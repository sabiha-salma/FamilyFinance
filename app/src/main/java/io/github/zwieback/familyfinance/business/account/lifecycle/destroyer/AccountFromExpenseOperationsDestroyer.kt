...
class AccountFromExpenseOperationsDestroyer(
    context: Context,
    ...
    override val alertResourceId: Int
        get() = R.string.expense_operations_with_account_exists

    override fun next(): EntityDestroyer<Account>? {
        return AccountFromIncomeOperationsDestroyer(context, data)
    }

    @Suppress("PARAMETER_NAME_CHANGED_ON_OVERRIDE")
    override fun getWhereCondition(account: Account): Condition<*, *> {
        return Operation.ACCOUNT_ID.eq(account.id)
