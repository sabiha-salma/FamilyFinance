...
class ArticleFromExpenseOperationsDestroyer(
    context: Context,
    ...
    override val alertResourceId: Int
        get() = R.string.expense_operations_with_article_exists

    override fun next(): EntityDestroyer<Article>? {
        return ArticleFromIncomeOperationsDestroyer(context, data)
    }
